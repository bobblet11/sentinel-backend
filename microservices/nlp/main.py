...
if __name__ == "__main__":
    ...
    config = ServiceConfig(max_workers=1, service_name=SERVICE_NAME, input_streams=[INPUT_STREAM], group_name=GROUP_NAME, consumer_name=CONSUMER_NAME, failure_output_stream=FAILURE_OUTPUT_STREAM, routing_map=routing_map, is_concurrent=False, batch_size=BATCH_SIZE )
