...
class UserAgentManager:
	...
	def __init__(self):         
		...
		try:
			all_browser_except_safari = ["Google", "Chrome", "Firefox", "Edge", "Opera", "Android", "Yandex Browser", "Samsung Internet", "Opera Mobile", "Firefox Mobile", "Firefox iOS", "Chrome Mobile", "Chrome Mobile iOS", "Edge Mobile", "DuckDuckGo Mobile", "MiuiBrowser", "Whale", "Twitter", "Facebook", "Amazon Silk"]
