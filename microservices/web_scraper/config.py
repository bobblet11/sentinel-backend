...
PROXY_VALIDATION_MAX_WORKERS: int = get_env_var("PROXY_VALIDATION_MAX_WORKERS",int, config_logger)
...
env_variables: List[EnvVariable] = [
    ...
    EnvVariable("PROXY_VALIDATION_MAX_WORKERS", PROXY_VALIDATION_MAX_WORKERS), 
