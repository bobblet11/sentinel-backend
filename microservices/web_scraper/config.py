...
INITIAL_FETCH_DELAY_S: float = get_env_var(
    "INITIAL_FETCH_DELAY_S", float, config_logger
)
FETCH_DELAY_GROWTH_RATE: float = get_env_var(
    "FETCH_DELAY_GROWTH_RATE", float, config_logger
)
MAX_SCREENSHOT_FOLDER_SIZE: float = get_env_var(
    "MAX_SCREENSHOT_FOLDER_SIZE", float, config_logger
)
