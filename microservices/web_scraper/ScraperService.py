...
class ScraperService:
    ...
    def run(self):
        ...
        with ThreadPoolExecutor(max_workers=SCRAPER_MAX_WORKERS) as executor:
            ...
            print(
                f"[{datetime.datetime.now()}] Checking for pending messages..."
            )
    ...
    def _publish_and_ack_worker(self, message: Dict[str, Any], publisher: RedisPublisherRouter | RedisPublisher) -> Dict[str, Any]:
        """
