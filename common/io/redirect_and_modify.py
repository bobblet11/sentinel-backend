...
def redirect_and_modify(string_modification_function: Callable=indent_with_tab) -> Callable:
    def decorator(func: Callable) -> Callable:
        def wrapper(*args: Tuple, **kwargs:Tuple):
            ...
            if lines[-1] == "":
                ...
                modified_lines:List[str] = [string_modification_function(line) for line in lines]
                final_output:str = "\n".join(modified_lines)
